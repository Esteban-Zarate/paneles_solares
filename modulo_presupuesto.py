...
# ─── Colores ─────────────────────────────────────────────────────────────────
SOL   = "#FF9F1C"; DARK  = "#F8F9FA"; CARD  = "#FFFFFF"
CARD2 = "#F8F9FA"; BRD   = "#0B2545"; TEXT  = "#0B2545"
TEXT2 = "#2E7D32"; GREEN = "#2E7D32"; CYAN  = "#0B2545"
MONO  = "#0B2545"; RED   = "#0B2545"
...
def mostrar_presupuesto(proyecto_id: int, ss: dict):
    ...
    st.markdown("""
    <div style='background:linear-gradient(135deg,#F8F9FA,#FFFFFF);border:1px solid #0B2545;
     border-radius:12px;padding:1.2rem 1.5rem;margin-bottom:1.5rem;'>
        <div style='font-family:Rajdhani,sans-serif;font-size:1.6rem;font-weight:700;
         color:#FF9F1C;letter-spacing:2px;'>💰 PRESUPUESTO DEL PROYECTO</div>
    ...
    with pt1:
        ...
        with fi7:
            ...
            <div style='background:#F8F9FA;border:1px solid #0B2545;border-radius:8px;
             padding:0.6rem;text-align:center;margin-top:1.55rem;'>
                <div style='font-size:0.7rem;color:#2E7D32;'>Valor parcial</div>
                <div style='font-family:Share Tech Mono,monospace;color:#FF9F1C;font-size:1rem;'>
                    ${vp_preview:,.0f}</div>
        ...
        if not items_df.empty:
            ...
            st.markdown(f"""
            <div style='background:#FFFFFF;border:1px solid rgba(255,179,0,0.4);border-radius:8px;
             padding:0.7rem 1.2rem;text-align:right;margin-top:0.5rem;'>
                <span style='color:#2E7D32;'>Subtotal {cap_sel_nom}:</span>
                <b style='font-family:Share Tech Mono,monospace;color:#FF9F1C;font-size:1.1rem;
    ...
    with pt5:
        ...
        st.markdown(f"""
        <div style='background:#FFFFFF;border:1px solid #0B2545;border-radius:12px;padding:1.5rem;'>
            <div style='font-family:Rajdhani,sans-serif;font-size:1.1rem;font-weight:700;
             color:#FF9F1C;letter-spacing:1px;margin-bottom:1rem;'>📊 RESUMEN GENERAL</div>
        """, unsafe_allow_html=True)
        ...
        for _, cap_r in caps_r.iterrows():
            ...
            <div style='display:flex;justify-content:space-between;padding:0.4rem 0;
             border-bottom:1px solid #FFFFFF;'>
                ...
                <b style='font-family:Share Tech Mono,monospace;color:#0B2545;'>
                    $ {sub_r:,.0f}</b>
            </div>""", unsafe_allow_html=True)

        st.markdown(f"""
            <div style='display:flex;justify-content:space-between;padding:0.6rem 0;margin-top:0.5rem;'>
                <span style='color:#2E7D32;'>SUBTOTAL DIRECTO</span>
                <b style='font-family:Share Tech Mono,monospace;color:#0B2545;'>$ {gran_total_r:,.0f}</b>
            </div>
            <div style='display:flex;justify-content:space-between;padding:0.4rem 0;'>
                <span style='color:#2E7D32;'>AIU ({aiu_pct:.1f}%)</span>
                <b style='font-family:Share Tech Mono,monospace;color:#0B2545;'>$ {aiu_val:,.0f}</b>
            </div>
            <div style='display:flex;justify-content:space-between;padding:0.8rem 0;
             border-top:2px solid #FF9F1C;margin-top:0.5rem;'>
                <span style='color:#FF9F1C;font-family:Rajdhani,sans-serif;font-size:1.1rem;
                 font-weight:700;'>TOTAL PRESUPUESTO</span>
                <b style='font-family:Share Tech Mono,monospace;color:#FF9F1C;font-size:1.3rem;'>
                    $ {total_c_aiu:,.0f}</b>
            </div>
        </div>""", unsafe_allow_html=True)
