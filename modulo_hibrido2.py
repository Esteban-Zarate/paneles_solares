...
def mostrar_hibrido(proyecto_id: int, session_state: dict) -> None:
    ...
    with tab_h1:
        ...
        for c_col, val, unit, lbl, col_c in [
            ...
            (col4, consumo_fs_hib, "Wh/día","Con 15% FS híbrido", "#FF9F1C"),
        ]:
            with c_col:
                st.markdown(f"""
    ...
    with tab_h2:
        ...
        with col_h21:
            st.markdown("""
            <div class='sol-card'>
                <div style='color:#FF9F1C;font-family:Rajdhani,sans-serif;font-weight:600;margin-bottom:0.8rem;'>
                    📊 Fuentes de Irradiación
                </div>
                <div style='font-size:0.85rem;color:#2E7D32;line-height:1.9;'>
                    ...
                    <b style='color:#0B2545;'>SolarGIS</b><br>
        ...
        with col_h22:
            ...
            <div class='result-highlight'>
                <div style='color:#2E7D32;font-size:0.8rem;'>{irr_hib} kWh/m²/mes ÷ 30 =</div>
                <div class='val'>{hsp_hib:.2f} h/día (HSP)</div>
                <div style='color:#FF9F1C;font-size:0.85rem;margin-top:0.3rem;'>
        ...
        with col_h32:
            ...
            <div class='sol-card'>
                ...
                <div style='margin-top:0.8rem;background:#F8F9FA;border-radius:8px;padding:0.8rem;text-align:center;'>
                    ...
                    <div style='font-size:0.72rem;color:#2E7D32;margin-top:0.3rem;'>Factor de Forma (≥72% ideal)</div>
                </div>
            </div>""", unsafe_allow_html=True)
    ...
    with tab_h4:
        ...
        with col_b1:
            st.markdown("<div class='sol-card'>", unsafe_allow_html=True)
            st.markdown("<div style='color:#2E7D32;font-family:Rajdhani,sans-serif;font-weight:600;margin-bottom:0.8rem;'>PARÁMETROS BANCO</div>", unsafe_allow_html=True)
        ...
        with col_b2:
            ...
            if consumo_fs_calc > 0:
                ...
                <div class='result-highlight' style='border-color:rgba(167,139,250,0.5);
                    ...
                    <div style='color:#2E7D32;font-size:0.8rem;'>Energía de respaldo requerida</div>
                    <div class='val' style='color:#2E7D32;'>{en_resp_wh/1000:.2f} kWh</div>
                </div>
                ...
                <div class='sol-card' style='margin-top:0.8rem;'>
                    ...
                    <table style='width:100%;font-size:0.82rem;border-collapse:collapse;'>
                        ...
                        <tr style='border-bottom:1px solid #0B2545;'>
                            <td style='color:#2E7D32;padding:0.35rem 0;'>Tensión sistema</td>
                        ...
                        <tr style='border-bottom:1px solid #0B2545;'>
                            <td style='color:#2E7D32;padding:0.35rem 0;'>Capacidad banco</td>
                            <td style='font-family:Share Tech Mono;color:#2E7D32;text-align:right;'>{cap_real_wh/1000:.2f} kWh</td>
                        </tr>
                        <tr style='border-bottom:1px solid #0B2545;'>
                            <td style='color:#2E7D32;padding:0.35rem 0;'>Energía útil (DoD {hib_dod}%)</td>
                            <td style='font-family:Share Tech Mono;color:#2E7D32;text-align:right;'>{cap_real_wh*hib_dod/100/1000:.2f} kWh</td>
                        </tr>
                        <tr>
                            <td style='color:#2E7D32;padding:0.35rem 0;'>Autonomía real</td>
                            <td style='font-family:Share Tech Mono;color:#2E7D32;text-align:right;'>{aut_real_h:.1f} h / {aut_real_h/24:.1f} días</td>
                        </tr>
                    </table>
                </div>""", unsafe_allow_html=True)
    ...
    with tab_h5:
        ...
        with col_d2:
            ...
            <div class='result-highlight' style='border-color:rgba(245,158,11,0.5);
                ...
                <div class='val' style='color:#FF9F1C;'>{pot_min_wp/1000:.2f} kWp</div>
            </div>
            ...
            <div style='display:grid;grid-template-columns:1fr 1fr;gap:0.6rem;margin-top:0.8rem;'>
              ...
              <div class='sol-card'>
                <div style='color:#2E7D32;font-family:Rajdhani,sans-serif;font-weight:600;margin-bottom:0.5rem;'>BATERÍAS</div>
                <table style='width:100%;font-size:0.8rem;border-collapse:collapse;'>
                  ...
                  <tr style='border-bottom:1px solid #0B2545;'><td style='color:#2E7D32;'>Cap. banco</td><td style='font-family:Share Tech Mono;color:#2E7D32;text-align:right;'>{cap_real/1000:.1f} kWh</td></tr>
                  <tr style='border-bottom:1px solid #0B2545;'><td style='color:#2E7D32;'>Autonomía</td><td style='font-family:Share Tech Mono;color:#2E7D32;text-align:right;'>{aut_real_hh:.1f} h</td></tr>
    ...
    with tab_h6:
        ...
        with col_e2:
            if pot_inst_e == 0 or consumo_fe == 0:
                ...
                <div class='metric-grid'>
                    <div class='metric-box' style='border-color:rgba(0,230,118,0.5);'>
                        <div class='metric-val' style='color:#2E7D32;'>{gen_dia_e:.2f}</div>
                    ...
                    <div class='metric-box' style='border-color:rgba(245,158,11,0.5);'>
                        <div class='metric-val' style='color:#FF9F1C;'>{ac_pct_e:.0f}%</div>
                    ...
                    <div class='metric-box' style='border-color:rgba(0,230,118,0.5);'>
                        <div class='metric-val' style='color:#2E7D32;'>{payback_h:.1f}</div>
                ...
                <div class='sol-card' style='margin-top:0.8rem;'>
                    ...
                    <table style='width:100%;font-size:0.82rem;border-collapse:collapse;'>
                        <tr style='border-bottom:1px solid #0B2545;'><td style='color:#2E7D32;'>Inversión paneles</td><td style='font-family:Share Tech Mono;color:#0B2545;text-align:right;'>${inv_pan_h:,.0f}</td></tr>
                        <tr style='border-bottom:1px solid #0B2545;'><td style='color:#2E7D32;'>Inversión inversor híbrido</td><td style='font-family:Share Tech Mono;color:#0B2545;text-align:right;'>${inv_inv_h:,.0f}</td></tr>
                        <tr style='border-bottom:1px solid #0B2545;'><td style='color:#2E7D32;'>Inversión baterías</td><td style='font-family:Share Tech Mono;color:#2E7D32;text-align:right;'>${inv_bat_h:,.0f}</td></tr>
                        <tr style='border-bottom:1px solid #0B2545;'><td style='color:#2E7D32;'>Otros (estructura+cable+MO)</td><td style='font-family:Share Tech Mono;color:#0B2545;text-align:right;'>${otros_h:,.0f}</td></tr>
                        ...
                        <tr style='border-bottom:1px solid #0B2545;'><td style='color:#2E7D32;'>Ahorro autoconsumo/mes</td><td style='font-family:Share Tech Mono;color:#2E7D32;text-align:right;'>${ahorro_mes_h:,.0f}</td></tr>
                        <tr style='border-bottom:1px solid #0B2545;'><td style='color:#2E7D32;'>Ingreso inyección/mes</td><td style='font-family:Share Tech Mono;color:#FF9F1C;text-align:right;'>${ing_iny_h:,.0f}</td></tr>
                        ...
                        <tr style='border-bottom:1px solid #0B2545;'><td style='color:#2E7D32;'>Gen. anual estimada</td><td style='font-family:Share Tech Mono;color:#0B2545;text-align:right;'>{gen_anio_h:,.0f} kWh</td></tr>
                        ...
                        <tr style='border-bottom:1px solid #0B2545;'><td style='color:#2E7D32;'>Árboles equivalentes</td><td style='font-family:Share Tech Mono;color:#0B2545;text-align:right;'>≈{arboles_h:.0f} árboles/año</td></tr>
                        <tr style='border-bottom:1px solid #0B2545;'><td style='color:#2E7D32;'>TIR simplificada</td><td style='font-family:Share Tech Mono;color:#0B2545;text-align:right;'>{tir_h:.1f}%/año</td></tr>
                        <tr><td style='color:#2E7D32;'>Autonomía batería</td><td style='font-family:Share Tech Mono;color:#2E7D32;text-align:right;'>{aut_h_e:.1f} h</td></tr>
                    </table>
                </div>""", unsafe_allow_html=True)
