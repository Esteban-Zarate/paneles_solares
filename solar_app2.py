...
with st.sidebar:
    ...
    <div style='text-align:center; padding:0.8rem 0 0.5rem;'>
        <div style='font-family:Rajdhani,sans-serif; font-size:2rem; color:#FF9F1C;
                    font-weight:700; letter-spacing:3px; line-height:1.1;'>
            ☀ ESTEBAN<br>ZARATE
        </div>
        <div style='font-size:0.65rem; color:#2E7D32; letter-spacing:3px;
                    margin-top:0.3rem; text-transform:uppercase;'>
            Dimensionamiento Fotovoltaico
        </div>
    </div>
    <hr style='border-color:#0B2545; margin:0.6rem 0;'>
    """, unsafe_allow_html=True)
    ...
    st.markdown("""
    <div style='font-size:0.65rem;color:#2E7D32;letter-spacing:2px;
    ...
    _SISTEMAS = [
        ("OFF-GRID", "🔋", "Aislado",        "#FF9F1C", "rgba(255,179,0,0.15)",  "dimensionamiento"),
        ("ON-GRID",  "🔌", "Interconectado", "#FF9F1C", "rgba(255,107,53,0.15)","ongrid"),
        ("HIBRIDO",  "⚡", "ON + Baterías",  "#FF9F1C", "rgba(245,158,11,0.15)","hibrido"),
    ]
    for _tipo, _icon, _sub, _col, _bg, _mod in _SISTEMAS:
        ...
        st.markdown(
            ...
            f"{_icon} {_tipo}<br>"
            f"<span style='font-size:0.62rem;font-weight:400;color:#2E7D32;'>{_sub}</span></div>",
            unsafe_allow_html=True)
        if _activo:
            st.markdown(
    ...
    st.markdown("<hr style='border-color:#0B2545;margin:0.7rem 0;'>", unsafe_allow_html=True)
    ...
    if proyecto_id:
        ...
        if p_sb:
            ...
            <div style='background:#FFFFFF;border:1px solid #0B2545;border-radius:8px;
                ...
                <div style='color:#FF9F1C;font-family:Rajdhani,sans-serif;
                            font-weight:700;font-size:0.95rem;'>
                    #{p_sb[0]} {p_sb[1]}</div>
                <div style='color:#2E7D32;font-size:0.72rem;margin-top:0.2rem;'>
                    📍 {mun_sb}</div>
                <div style='display:flex;gap:0.8rem;margin-top:0.3rem;'>
                    <span style='font-size:0.72rem;color:#0B2545;'>
                        ☀ HSP: {hsp_sb} h</span>
                    <span style='font-size:0.72rem;color:#0B2545;'>
                        ⚡ VDC: {vdc_sb} V</span>
                </div>
        ...
        <div style='background:#FFFFFF;border:1px dashed #0B2545;border-radius:8px;
            ...
            <div style='color:#0B2545;font-size:0.78rem;'>Sin proyecto seleccionado</div>
        </div>
        """, unsafe_allow_html=True)
    ...
    st.markdown("<hr style='border-color:#0B2545;margin:0.6rem 0;'>", unsafe_allow_html=True)
    ...
    for grupo_label, modulos in GRUPOS_MODULOS:
        st.markdown(f"""
        <div style='font-size:0.6rem;color:#0B2545;letter-spacing:2px;
        ...
        for label, key in modulos:
            ...
            if activo:
                ...
                <div style='background:rgba(255,179,0,0.12);border:1px solid rgba(255,179,0,0.45);
                            ...
                            font-family:Barlow,sans-serif;font-size:0.85rem;color:#FF9F1C;
    ...
    _col_ts = {"ON-GRID":"#FF9F1C","HIBRIDO":"#FF9F1C"}.get(tipo_sistema_activo,"#FF9F1C")
    st.markdown(f"""
    <div style='text-align:center;padding:0.3rem 0;'>
        <div style='font-size:0.62rem;color:#0B2545;letter-spacing:1px;'>
            EcoVolt Pro v1.2 · Esteban Zarate<br>
            SQLite3 + Streamlit<br>
            Sistema: <span style='color:{_col_ts};'>
                {tipo_sistema_activo}</span><br>
            Módulo: <span style='color:#2E7D32;'>
...
if not proyecto_id and modulo_activo not in ("materiales", "equipos", "personal"):
    ...
    <div class='sol-card' style='text-align:center; padding:3rem;'>
        ...
        <div style='font-family:Rajdhani,sans-serif; font-size:1.5rem; color:#FF9F1C; margin-top:1rem;'>
            SELECCIONA O CREA UN PROYECTO</div>
        <div style='color:#2E7D32; margin-top:0.5rem;'>Usa el panel lateral para comenzar</div>
    </div>
    """, unsafe_allow_html=True)
    st.stop()
...
with tab1:
    ...
    with st.expander("📋  CATÁLOGO DE ELECTRODOMÉSTICOS — Potencias Estándar", expanded=True):
        ...
        for categoria, equipos in CATALOGO.items():
            ...
            st.markdown(f"<div style='color:#FF9F1C; font-family:Rajdhani,sans-serif; font-weight:600; font-size:0.95rem; margin:0.8rem 0 0.4rem; letter-spacing:1px;'>{categoria}</div>", unsafe_allow_html=True)
        ...
        if n_sel > 0:
            ...
            <div style='font-family:Rajdhani,sans-serif; font-size:0.95rem; font-weight:600;
                        color:#FF9F1C; letter-spacing:1px; margin:1rem 0 0.4rem;'>
            ...
            <div style='display:grid; grid-template-columns:repeat(3,1fr); gap:0.8rem; margin:0.8rem 0;'>
                <div style='background:#F8F9FA; border:1px solid #0B2545; border-radius:8px;
                    ...
                    <div style='font-family:Share Tech Mono; font-size:1.4rem; color:#0B2545;'>{total_pot:,.0f}</div>
                    <div style='font-size:0.72rem; color:#2E7D32; margin-top:0.2rem;
                ...
                <div style='background:#F8F9FA; border:1px solid rgba(255,179,0,0.45); border-radius:8px;
                            padding:0.8rem; text-align:center;'>
                    <div style='font-family:Share Tech Mono; font-size:1.4rem; color:#FF9F1C;'>{total_preview:,.0f}</div>
                    <div style='font-size:0.72rem; color:#2E7D32; margin-top:0.2rem;
                ...
                <div style='background:#F8F9FA; border:1px solid rgba(0,230,118,0.4); border-radius:8px;
                            padding:0.8rem; text-align:center;'>
                    <div style='font-family:Share Tech Mono; font-size:1.4rem; color:#2E7D32;'>{total_preview_fs:,.0f}</div>
                    <div style='font-size:0.72rem; color:#2E7D32; margin-top:0.2rem;
    ...
    if cargas.empty:
        ...
        <div class='result-highlight'>
            <div style='color:#2E7D32; font-size:0.8rem; text-transform:uppercase; letter-spacing:1px;'>Potencia Inversor Recomendada (con 25% FS)</div>
        ...
        <div style='font-family:Rajdhani,sans-serif; font-size:1.1rem; font-weight:600;
                    color:#FF9F1C; letter-spacing:1px; margin-bottom:0.8rem;'>
        ...
        with st.expander(f"📝  Editando: {fila_sel['electrodomestico']}", expanded=True):
            ...
            <div style='background:#F8F9FA; border:1px dashed #0B2545; border-radius:8px;
                        padding:0.6rem 1rem; font-size:0.82rem; color:#2E7D32; margin:0.5rem 0;
                        display:flex; gap:2rem; flex-wrap:wrap;'>
                <span>Pot. total: <b style='color:#0B2545;'>{pot_t_prev:,} W</b></span>
                <span>Consumo/día: <b style='color:#0B2545;'>{cons_prev:,.1f} Wh</b></span>
        ...
        with col_dl1:
            ...
            <div style='background:#FFFFFF; border:1px solid #0B2545; border-radius:10px;
                ...
                <div style='font-family:Rajdhani,sans-serif; color:#FF9F1C; font-weight:600;'>EXCEL (.xlsx)</div>
                <div style='font-size:0.78rem; color:#2E7D32; margin-top:0.3rem;'>
        ...
        with col_dl2:
            ...
            <div style='background:#FFFFFF; border:1px solid #0B2545; border-radius:10px;
                        padding:1rem; text-align:center; margin-bottom:0.5rem;'>
                <div style='font-size:2rem;'>📄</div>
                <div style='font-family:Rajdhani,sans-serif; color:#FF9F1C; font-weight:600;'>PDF (.pdf)</div>
                <div style='font-size:0.78rem; color:#2E7D32; margin-top:0.3rem;'>
...
with tab2:
    ...
    with st.expander("➕ Registrar recibo de energía", expanded=True):
        st.markdown("<div style='color:#FF9F1C; font-family:Rajdhani,sans-serif; font-weight:600; margin-bottom:0.8rem;'>DATOS DEL RECIBO</div>", unsafe_allow_html=True)
        ...
        if rec_kwh > 0 and rec_dias > 0:
            ...
            costo_span = (f'<span style="font-size:0.82rem; color:#2E7D32;">Costo/día: '
                          f'<b style="color:#0B2545; font-family:Share Tech Mono;">'
            ...
            <div style='background:#F8F9FA; border:1px dashed #FF9F1C; border-radius:8px;
                ...
                <span style='font-size:0.82rem; color:#2E7D32;'>kWh/día:
                    <b style='color:#0B2545; font-family:Share Tech Mono;'>{kwh_dia_prev:.2f}</b></span>
                <span style='font-size:0.82rem; color:#2E7D32;'>Wh/día:
                    <b style='color:#FF9F1C; font-family:Share Tech Mono;'>{wh_dia_prev:,.0f}</b></span>
                <span style='font-size:0.82rem; color:#2E7D32;'>Wh/día +25% FS:
                    <b style='color:#2E7D32; font-family:Share Tech Mono;'>{wh_dia_fs:,.0f}</b></span>
                {costo_span}
            </div>
            """, unsafe_allow_html=True)
    ...
    if recibos_df.empty:
        ...
        st.markdown(f"""
        <div style='font-family:Rajdhani,sans-serif; font-size:1.1rem; font-weight:600;
                    color:#FF9F1C; letter-spacing:1px; margin-bottom:0.5rem;'>
        ...
        <div style='background:rgba(0,188,212,0.08);border:1px solid rgba(0,188,212,0.25);
            ...
            ℹ El recibo de energía refleja el <b style='color:#0B2545;'>consumo real total</b>
            ...
            <b style='color:#0B2545;'>El dimensionamiento se basa en el valor que selecciones abajo.</b>
        </div>
        <div style='font-size:0.8rem; color:#2E7D32; margin-bottom:1rem;'>
            Período de referencia: <b style='color:#0B2545;'>{recibo_ref['periodo']}</b>
        ...
        with col_cmp1:
            st.markdown(f"""
            <div class='metric-box' style='border-color:#0B2545;'>
                <div style='font-size:1.2rem; margin-bottom:0.3rem;'>🧾</div>
                <div class='metric-val' style='color:#0B2545;'>{wh_dia_ref:,.0f}</div>
                <div class='metric-unit'>Wh/día</div>
                <div class='metric-label'>RECIBO REAL</div>
            </div>""", unsafe_allow_html=True)
        with col_cmp2:
            st.markdown(f"""
            <div class='metric-box' style='border-color:#2E7D32;'>
                <div style='font-size:1.2rem; margin-bottom:0.3rem;'>🧾</div>
                <div class='metric-val' style='color:#2E7D32;'>{wh_dia_fs_ref:,.0f}</div>
                <div class='metric-unit'>Wh/día</div>
                <div class='metric-label'>RECIBO + 25% FS</div>
            </div>""", unsafe_allow_html=True)
        with col_cmp3:
            st.markdown(f"""
            <div class='metric-box' style='border-color:#FF9F1C;'>
                <div style='font-size:1.2rem; margin-bottom:0.3rem;'>⚡</div>
        ...
        with col_cmp4:
            ...
            if consumo_inv > 0 and wh_dia_ref > 0:
                ...
                cob_color = "#2E7D32" if pct_cob >= 80 else "#0B2545"
                st.markdown(f"""
                ...
                <div class='metric-box' style='border-color:#0B2545;'>
                    <div style='font-size:1.2rem; margin-bottom:0.3rem;'>📋</div>
                    <div class='metric-val' style='color:#2E7D32;'>—</div>
        ...
        if consumo_inv > 0 and wh_dia_ref > 0:
            ...
            if pct_cob2 < 85:
                ...
                <div style='background:rgba(255,211,78,0.07);border:1px solid rgba(255,211,78,0.2);
                    ...
                    <b style='color:#0B2545;'>El recibo es la base recomendada para dimensionar.</b>
                </div>
                """, unsafe_allow_html=True)
        ...
        st.markdown(f"""
        <div class='result-highlight'>
            <div style='color:#2E7D32; font-size:0.8rem; text-transform:uppercase; letter-spacing:1px;'>
                Consumo base seleccionado → con Factor de Seguridad 25%
            </div>
            <div class='val'>{consumo_base_sel:,.0f} Wh/día
                <span style='font-size:1rem; color:#2E7D32;'>→</span>
                <span style='color:#2E7D32;'>{consumo_base_fs_sel:,.0f} Wh/día</span>
            </div>
        </div>
        """, unsafe_allow_html=True)
        ...
        if len(recibos_df) >= 2:
            ...
            with col_t2:
                st.markdown(f"""
                <div class='metric-box' style='border-color:#0B2545;'>
                    <div class='metric-val' style='color:#0B2545;'>{kwh_max:.2f}</div>
                    <div class='metric-unit'>kWh/día</div>
            ...
            with col_t3:
                st.markdown(f"""
                <div class='metric-box' style='border-color:#2E7D32;'>
                    <div class='metric-val' style='color:#2E7D32;'>{kwh_min:.2f}</div>
                    <div class='metric-unit'>kWh/día</div>
...
with tab3:
    ...
    if consumo_base2 == 0:
        ...
        if consumo_rec2 > 0:
            st.markdown(f"""
            <div class='info-note' style='margin-bottom:1rem;'>
                Inventario de cargas: <b style='color:#0B2545;'>{consumo_inv2:,.0f} Wh/día</b> &nbsp;|&nbsp;
                Recibo ({periodo_rec2}): <b style='color:#0B2545;'>{consumo_rec2:,.0f} Wh/día</b> &nbsp;|&nbsp;
        ...
        for i, (rango, volt, activo) in enumerate(rangos):
            with cols_r[i]:
                color = "#FF9F1C" if activo else "#0B2545"
                ...
                <div style='background:{bg}; border:2px solid {color}; border-radius:12px; padding:1.5rem; text-align:center;'>
                    <div style='font-size:0.75rem; color:#2E7D32; text-transform:uppercase; letter-spacing:1px;'>{rango}</div>
        ...
        <div class='result-highlight' style='margin-top:1.5rem;'>
            <div style='color:#2E7D32; font-size:0.8rem; text-transform:uppercase; letter-spacing:1px;'>Consumo diario (con FS 25%): {consumo_fs2:,.0f} Wh/día</div>
...
with tab4:
    ...
    with col_pvg1:
        st.markdown("""
        <div class='sol-card'>
            <div style='color:#FF9F1C; font-family:Rajdhani,sans-serif; font-size:1.1rem; font-weight:600; margin-bottom:0.8rem;'>🌐 Herramienta PVGIS (Europa JRC)</div>
            <div style='color:#2E7D32; font-size:0.85rem; margin-bottom:1rem;'>
        ...
        <div class='sol-card' style='margin-top:1rem;'>
            <div style='color:#FF9F1C; font-family:Rajdhani,sans-serif; font-weight:600; margin-bottom:0.8rem;'>📋 Instrucciones PVGIS</div>
            <ol style='color:#2E7D32; font-size:0.85rem; line-height:1.8;'>
    ...
    with col_pvg2:
        ...
        st.markdown(f"""
        <div class='result-highlight'>
            <div style='color:#2E7D32; font-size:0.8rem; text-transform:uppercase;'>
                {irradiacion} kWh/m²/mes ÷ 30 días =
            </div>
            <div class='val'>{hsp_calc:.2f} h</div>
            <div style='color:#0B2545; font-size:0.85rem; margin-top:0.3rem;'>Horas Solar Pico ({mes_menor})</div>
        </div>
        """, unsafe_allow_html=True)
        ...
        if dias_autonomia > 1:
            st.markdown(f"""
            <div class='result-ok'>
                <div style='color:#2E7D32; font-size:0.8rem;'>HSP ajustada ({dias_autonomia} días)</div>
...
with tab5:
    ...
    with col_p2:
        st.markdown(f"""
        <div class='sol-card'>
            <div style='color:#FF9F1C; font-family:Rajdhani,sans-serif; font-weight:600; margin-bottom:1rem; font-size:1.1rem;'>
                FICHA TÉCNICA
            </div>
            <div style='display:grid; grid-template-columns:1fr 1fr; gap:0.8rem;'>
                <div style='background:#F8F9FA; border-radius:8px; padding:1rem; text-align:center;'>
                    <div style='font-family:Share Tech Mono; font-size:1.8rem; color:#FF9F1C;'>{panel_wp}</div>
                    <div style='font-size:0.75rem; color:#2E7D32; margin-top:0.3rem;'>Wp — POTENCIA PICO</div>
                </div>
                <div style='background:#F8F9FA; border-radius:8px; padding:1rem; text-align:center;'>
                    <div style='font-family:Share Tech Mono; font-size:1.8rem; color:#0B2545;'>{panel_voc}</div>
                    <div style='font-size:0.75rem; color:#2E7D32; margin-top:0.3rem;'>V — Voc CIRCUITO ABIERTO</div>
                </div>
                <div style='background:#F8F9FA; border-radius:8px; padding:1rem; text-align:center;'>
                    <div style='font-family:Share Tech Mono; font-size:1.8rem; color:#2E7D32;'>{panel_isc}</div>
                    <div style='font-size:0.75rem; color:#2E7D32; margin-top:0.3rem;'>A — Isc CORTOCIRCUITO</div>
                </div>
                <div style='background:#F8F9FA; border-radius:8px; padding:1rem; text-align:center;'>
                    <div style='font-family:Share Tech Mono; font-size:1.8rem; color:#0B2545;'>{(panel_wp/panel_voc):.1f}</div>
                    <div style='font-size:0.75rem; color:#2E7D32; margin-top:0.3rem;'>A — Impp APROX</div>
                </div>
            </div>
            <div style='margin-top:1rem; color:#2E7D32; font-size:0.8rem;'>
                Modelo: <span style='color:#0B2545;'>{panel_modelo or "Sin especificar"}</span>
            </div>
        </div>
        """, unsafe_allow_html=True)
    ...
    if consumo5 == 0:
        ...
        if consumo_rec5 > 0:
            ...
            <div class='info-note' style='margin-bottom:0.8rem;'>
                Inventario: <b style='color:#0B2545;'>{consumo_inv5:,.0f} Wh/día</b> &nbsp;|&nbsp;
                Recibo: <b style='color:#0B2545;'>{consumo_rec5:,.0f} Wh/día</b> &nbsp;|&nbsp;
        ...
        with col5a:
            ...
            st.markdown(f"""
            <hr class='sep'>
            <div style='color:#2E7D32; font-size:0.8rem; margin-bottom:0.5rem;'>
                {consumo5_fs:,.0f} Wh ÷ ({hsp_input5} h × {pr_input5}%) =
                <b style='color:#0B2545;'>{hsp_efectiva5:.2f} h efectivas</b>
            </div>
            """, unsafe_allow_html=True)
            st.markdown("</div>", unsafe_allow_html=True)
        ...
        with col5b:
            ...
            <div class='metric-grid'>
                ...
                <div class='metric-box' style='border-color:rgba(0,230,118,0.4);'>
                    <div class='metric-val' style='color:#2E7D32;'>{pot_real5:,}</div>
                ...
                <div class='metric-box' style='border-color:rgba(0,188,212,0.4);'>
                    <div class='metric-val' style='color:#0B2545;'>{gen_dia5_kwh:.2f}</div>
                    <div class='metric-unit'>kWh/día</div>
                    <div class='metric-label'>GENERACIÓN ESTIMADA</div>
                </div>
            </div>
            <div class='sol-card' style='margin-top:0.8rem;'>
                <div style='color:#FF9F1C;font-family:Rajdhani,sans-serif;font-weight:600;
                            margin-bottom:0.5rem;font-size:0.9rem;'>
                    DESGLOSE PÉRDIDAS (PR {pr_input5}%)</div>
                <table style='width:100%;font-size:0.8rem;border-collapse:collapse;'>
                    <tr style='border-bottom:1px solid #0B2545;'>
                        <td style='color:#2E7D32;padding:0.3rem 0;'>HSP bruta (PVGIS)</td>
                        <td style='font-family:Share Tech Mono;color:#0B2545;text-align:right;'>{hsp_input5:.2f} h/día</td>
                    </tr>
                    <tr style='border-bottom:1px solid #0B2545;'>
                        <td style='color:#2E7D32;padding:0.3rem 0;'>Performance Ratio</td>
                        <td style='font-family:Share Tech Mono;color:#FF9F1C;text-align:right;'>{pr_input5}%</td>
                    </tr>
                    <tr style='border-bottom:1px solid #0B2545;background:#FFFFFF;'>
                        <td style='color:#FF9F1C;padding:0.3rem 0;font-weight:600;'>HSP efectiva</td>
                        <td style='font-family:Share Tech Mono;color:#FF9F1C;text-align:right;font-weight:700;'>{hsp_efectiva5:.2f} h/día</td>
                    </tr>
                    <tr style='border-bottom:1px solid #0B2545;'>
                        <td style='color:#2E7D32;padding:0.3rem 0;'>Consumo con FS 25%</td>
                        <td style='font-family:Share Tech Mono;color:#0B2545;text-align:right;'>{consumo5_fs:,.0f} Wh/día</td>
                    </tr>
                    <tr>
                        <td style='color:#2E7D32;padding:0.3rem 0;'>Generación anual est.</td>
                        <td style='font-family:Share Tech Mono;color:#2E7D32;text-align:right;'>{gen_dia5_kwh*365:,.0f} kWh/año</td>
                    </tr>
                </table>
            </div>
            """, unsafe_allow_html=True)
...
with tab7:
    ...
    if consumo6 == 0:
        ...
        if consumo_rec6 > 0:
            st.markdown(f"""
            <div class='info-note' style='margin-bottom:0.8rem;'>
                Inventario: <b style='color:#0B2545;'>{consumo_inv6:,.0f} Wh/día</b> &nbsp;|&nbsp;
                Recibo: <b style='color:#0B2545;'>{consumo_rec6:,.0f} Wh/día</b> &nbsp;|&nbsp;
        ...
        with col6b:
            st.markdown(f"""
            <div class='sol-card'>
            <div style='color:#FF9F1C; font-family:Rajdhani,sans-serif; font-weight:600; margin-bottom:1rem;'>PASO A PASO</div>
            <table style='width:100%; font-size:0.85rem; border-collapse:collapse;'>
                <tr style='border-bottom:1px solid #0B2545;'>
                    <td style='color:#2E7D32; padding:0.4rem 0;'>Consumo diario (con FS 25%)</td>
                    <td style='font-family:Share Tech Mono; color:#0B2545; text-align:right;'>{consumo6_fs:,.0f} Wh</td>
                </tr>
                <tr style='border-bottom:1px solid #0B2545;'>
                    <td style='color:#2E7D32; padding:0.4rem 0;'>Tensión DC del sistema</td>
                    <td style='font-family:Share Tech Mono; color:#0B2545; text-align:right;'>{vdc_input6} V</td>
                </tr>
                <tr style='border-bottom:1px solid #0B2545;'>
                    <td style='color:#2E7D32; padding:0.4rem 0;'>{consumo6_fs:,.0f} ÷ {vdc_input6} =</td>
                    <td style='font-family:Share Tech Mono; color:#0B2545; text-align:right;'>{ah_bruto6:.1f} Ah</td>
                </tr>
                <tr style='border-bottom:1px solid #0B2545;'>
                    <td style='color:#2E7D32; padding:0.4rem 0;'>{ah_bruto6:.1f} ÷ {dod_dec:.2f} (DOD {dod_input6}%) =</td>
                    <td style='font-family:Share Tech Mono; color:#0B2545; text-align:right;'>{ah_dod6:.1f} Ah</td>
                </tr>
                <tr style='border-bottom:1px solid #0B2545;'>
                    <td style='color:#2E7D32; padding:0.4rem 0;'>{ah_dod6:.1f} ÷ 0.85 (+15% pérdidas) =</td>
                    <td style='font-family:Share Tech Mono; color:#2E7D32; text-align:right;'>{ah_final6:.0f} Ah</td>
                </tr>
            </table>
            </div>
            """, unsafe_allow_html=True)
        ...
        st.markdown(f"""
        <div class='result-highlight'>
            <div style='color:#2E7D32; font-size:0.8rem; text-transform:uppercase; letter-spacing:1px;'>Capacidad Total Requerida</div>
            <div class='val'>{ah_final6:.0f} Ah @ {vdc_input6} V</div>
        </div>
        <div class='metric-grid'>
            <div class='metric-box' style='border-color:rgba(0,230,118,0.4);'>
                <div class='metric-val' style='color:#2E7D32;'>{num_bat6}</div>
...
with tab8:
    ...
    if consumo7 == 0:
        ...
        if consumo_rec7 > 0:
            st.markdown(f"""
            <div class='info-note' style='margin-bottom:0.8rem;'>
                Inventario: <b style='color:#0B2545;'>{consumo_inv7:,.0f} Wh/día</b> &nbsp;|&nbsp;
                Recibo: <b style='color:#0B2545;'>{consumo_rec7:,.0f} Wh/día</b> &nbsp;|&nbsp;
        ...
        with col7b:
            ...
            <div style='background:var(--card); border:1px solid var(--border); border-radius:12px; padding:1.5rem;'>
                <div style='color:#FF9F1C; font-family:Rajdhani,sans-serif; font-weight:600; font-size:1.1rem; margin-bottom:1rem;'>
                    ESPECIFICACIONES MPPT REQUERIDAS
                </div>
                <table style='width:100%; font-size:0.85rem; border-collapse:collapse;'>
                    <tr style='border-bottom:1px solid #0B2545;'>
                        <td style='color:#2E7D32; padding:0.5rem 0;'>Tensión del sistema</td>
                        <td style='font-family:Share Tech Mono; color:#0B2545; text-align:right;'>{vdc_7} V</td>
                    </tr>
                    <tr style='border-bottom:1px solid #0B2545;'>
                        <td style='color:#2E7D32; padding:0.5rem 0;'>Capacidad banco baterías</td>
                        <td style='font-family:Share Tech Mono; color:#0B2545; text-align:right;'>{ah_banco_7} Ah</td>
                    </tr>
                    <tr style='border-bottom:1px solid #0B2545;'>
                        <td style='color:#2E7D32; padding:0.5rem 0;'>Potencia mínima paneles</td>
                        <td style='font-family:Share Tech Mono; color:#0B2545; text-align:right;'>{pot_paneles_7:,} Wp</td>
                    </tr>
                    <tr style='border-bottom:1px solid #0B2545;'>
                        <td style='color:#2E7D32; padding:0.5rem 0;'>{ah_banco_7} Ah × 0.20 =</td>
                ...
                <div style='margin-top:1rem; background:rgba(255,179,0,0.08); border:1px solid rgba(255,179,0,0.3); border-radius:8px; padding:1rem; text-align:center;'>
                    <div style='color:#2E7D32; font-size:0.75rem; text-transform:uppercase; letter-spacing:1px;'>Controlador Recomendado</div>
        ...
        st.markdown("<hr class='sep'>", unsafe_allow_html=True)
        st.markdown("""
        <div style='font-family:Rajdhani,sans-serif; font-size:1.4rem; font-weight:700; color:#FF9F1C; letter-spacing:2px; margin-bottom:1rem;'>
        ...
        if not recibo_res.empty:
            ...
            <div style='background:rgba(0,188,212,0.08); border:1px solid rgba(0,188,212,0.3);
                ...
                <span style='font-size:0.82rem; color:#2E7D32;'>Último recibo:
                    <b style='color:#0B2545;'>{r0['periodo']}</b></span>
                <span style='font-size:0.82rem; color:#2E7D32;'>Total período:
                    <b style='color:#0B2545; font-family:Share Tech Mono;'>{r0['kwh_periodo']:.1f} kWh</b></span>
                <span style='font-size:0.82rem; color:#2E7D32;'>Promedio diario:
                    <b style='color:#0B2545; font-family:Share Tech Mono;'>{kwh_dia_r0:.2f} kWh/día
                    ({kwh_dia_r0*1000:,.0f} Wh/día)</b></span>
                <span style='font-size:0.82rem; color:#2E7D32;'>Base usada:
                    <b style='color:#2E7D32;'>{consumo7:,.0f} Wh/día</b></span>
            </div>
            """, unsafe_allow_html=True)
...
with tab9:
    ...
    <div style='background:rgba(0,0,0,0.2);border:1px solid {fuente_color9}55;
        ...
        <span style='font-size:0.8rem;color:#2E7D32;'>
            Consumo base: <b style='color:#0B2545;'>{consumo_base9:,.0f} Wh/día</b>
            → con FS 25%: <b style='color:#0B2545;'>{consumo_fs9:,.0f} Wh/día</b>
            | HSP: <b style='color:#0B2545;'>{hsp9} h</b>
            | PR: <b style='color:#FF9F1C;'>{int(calc_pr9*100)}%</b>
            | VDC: <b style='color:#0B2545;'>{vdc9} V</b>
        </span>
    </div>
    """, unsafe_allow_html=True)
    ...
    with st.expander("📊 Ver comparativa de fuentes disponibles"):
        ...
        fuentes_comp = [
            ("⚡ Inventario", consumo_inv9,  "#FF9F1C"),
            ("🧾 Recibo",     consumo_rec9,  "#0B2545"),
        ...
        for col_c, (lbl_c, cons_c, clr_c) in zip(src_cols, fuentes_comp):
            if cons_c > 0:
                ...
                <div style='background:#FFFFFF;border:1px solid {clr_c}44;
                    ...
                    <div style='font-size:0.75rem;color:#2E7D32;'>{lbl_c}</div>
                    <div style='font-family:Share Tech Mono,monospace;
                                font-size:1.3rem;color:{clr_c};'>{cons_c:,.0f}</div>
                    <div style='font-size:0.7rem;color:#2E7D32;'>Wh/día</div>
                    <div style='font-family:Share Tech Mono,monospace;
                                font-size:1rem;color:#0B2545;margin-top:0.3rem;'>
                        {n_c} paneles</div>
                </div>""", unsafe_allow_html=True)
            else:
                col_c.markdown(f"""
                <div style='background:#F8F9FA;border:1px dashed #0B2545;
                            border-radius:8px;padding:0.8rem;text-align:center;
                            color:#0B2545;font-size:0.8rem;'>{lbl_c}<br>Sin datos</div>""",
                    unsafe_allow_html=True)
    ...
    with col9b:
        ...
        <div style='background:#F8F9FA; border:1px solid rgba(255,179,0,0.3); border-radius:6px;
            ...
            <span style='color:#2E7D32;'>Paneles requeridos: </span>
            <b style='color:#FF9F1C; font-family:Share Tech Mono,monospace;'>{n_paneles9} × {int(pot_panel9)}Wp</b>
            <span style='color:#2E7D32;'> | Vdc: </span>
            <b style='color:#0B2545; font-family:Share Tech Mono,monospace;'>{vdc9}V</b>
        </div>
        """, unsafe_allow_html=True)
        ...
        if total_array != n_paneles9:
            ...
            diff_color = "#0B2545" if diff < 0 else "#0B2545"
            st.markdown(f"""
            <div style='background:rgba(255,179,0,0.06); border:1px dashed rgba(255,179,0,0.3);
                        border-radius:6px; padding:0.4rem 0.8rem; font-size:0.78rem; color:#2E7D32;'>
                Array: <b style='color:{diff_color};'>{total_array} paneles</b>
                vs requeridos: <b style='color:#FF9F1C;'>{n_paneles9}</b>
    ...
    with col9c:
        ...
        techo_azimut = st.selectbox("Orientación (azimut)", ["Norte (0°)", "Noreste (45°)",
                                     ...
                                     index=4, key="p9_azim")
        techo_color  = st.color_picker("Color cubierta", "#0B2545", key="p9_color")
        st.markdown("</div>", unsafe_allow_html=True)
    ...
    def panel_svg(x, y, pw, ph, idx):
        ...
        <g class="panel">
          ...
          <rect x="{x+2:.1f}" y="{y+2:.1f}" width="{pw-4:.1f}" height="{ph-4:.1f}"
                rx="2" fill="none" stroke="#0B2545" stroke-width="0.5" opacity="0.5"/>
          {cells}
          <rect x="{jbx:.1f}" y="{jby:.1f}" width="12" height="6" rx="1"
                fill="#0B2545" stroke="#FF9F1C" stroke-width="0.8"/>
          {label_num}
        </g>'''
    ...
    compass_svg = f'''
    <g>
      <circle cx="{cx_comp}" cy="{cy_comp}" r="18" fill="#F8F9FA" stroke="#0B2545" stroke-width="1"/>
    ...
    title_svg = f'''
    <rect x="0" y="{title_y}" width="{svg_w}" height="68" fill="#FFFFFF" stroke="#0B2545" stroke-width="0.8"/>
    ...
    <text x="12" y="{title_y+60}" font-family="Share Tech Mono,monospace" font-size="8" fill="#0B2545">
    ...
    with col9_leg1:
        st.markdown(f"""
        <div class='sol-card'>
            <div style='font-family:Rajdhani,sans-serif; color:#FF9F1C; font-weight:600; margin-bottom:0.6rem;'>LEYENDA</div>
            <div style='font-size:0.82rem; line-height:2;'>
                <span style='color:#0B2545;'>█</span> Panel solar {pot_panel9}Wp<br>
                ...
                <span style='color:#FF9F1C;'>□</span> Caja de conexiones MPPT
            </div>
        </div>""", unsafe_allow_html=True)
    with col9_leg2:
        st.markdown(f"""
        <div class='sol-card'>
            <div style='font-family:Rajdhani,sans-serif; color:#FF9F1C; font-weight:600; margin-bottom:0.6rem;'>RESUMEN DEL ARRAY</div>
            <div style='font-size:0.82rem; line-height:2; font-family:Share Tech Mono,monospace;'>
                Paneles totales: <b style='color:#0B2545;'>{total_array}</b><br>
                Configuración: <b style='color:#0B2545;'>{serie_sel}S × {paralelo_sel}P</b><br>
                Vtotal array: <b style='color:#0B2545;'>{v_array} V</b><br>
                Itotal array: <b style='color:#0B2545;'>{i_array} A</b><br>
                Potencia total: <b style='color:#2E7D32;'>{pot_array} kWp</b>
            </div>
        </div>""", unsafe_allow_html=True)
    with col9_leg3:
        st.markdown(f"""
        <div class='sol-card'>
            <div style='font-family:Rajdhani,sans-serif; color:#FF9F1C; font-weight:600; margin-bottom:0.6rem;'>DIMENSIONES FÍSICAS</div>
            <div style='font-size:0.82rem; line-height:2; font-family:Share Tech Mono,monospace;'>
                Panel: <b style='color:#0B2545;'>{pw_disp}×{ph_disp} mm</b><br>
                Ancho array: <b style='color:#0B2545;'>{total_w/ESCALA/1000:.2f} m</b><br>
                Alto array: <b style='color:#0B2545;'>{total_h/ESCALA/1000:.2f} m</b><br>
                Área neta: <b style='color:#0B2545;'>{(total_w/ESCALA/1000)*(total_h/ESCALA/1000):.1f} m²</b><br>
                Inclinación: <b style='color:#2E7D32;'>{techo_inclin}° — {techo_azimut}</b>
            </div>
        </div>""", unsafe_allow_html=True)
...
with tab10:
    ...
    <div style='background:rgba(0,0,0,0.2);border:1px solid {fuente_color10}55;
        ...
        <span style='font-size:0.8rem;color:#2E7D32;'>
            Consumo: <b style='color:#0B2545;'>{consumo_base10:,.0f} Wh/día</b>
            | PR: <b style='color:#FF9F1C;'>{int(calc_pr10*100)}%</b>
            → FS: <b style='color:#0B2545;'>{consumo10_fs:,.0f} Wh/día</b>
            | HSP: <b style='color:#0B2545;'>{hsp10} h</b>
            | VDC: <b style='color:#0B2545;'>{vdc10} V</b>
            | Banco: <b style='color:#0B2545;'>{ah_banco10} Ah</b>
        </span>
    </div>
    """, unsafe_allow_html=True)
    ...
    with st.expander("📊 Ver comparativa de fuentes disponibles"):
        ...
        fuentes10_comp = [
            ("⚡ Inventario", consumo_inv10,   "#FF9F1C"),
            ("🧾 Recibo",     consumo_rec10,   "#0B2545"),
        ...
        for col_c10, (lbl_c10, cons_c10, clr_c10) in zip(src10_cols, fuentes10_comp):
            if cons_c10 > 0:
                ...
                <div style='background:#FFFFFF;border:1px solid {clr_c10}44;
                            border-radius:8px;padding:0.8rem;text-align:center;'>
                    <div style='font-size:0.75rem;color:#2E7D32;'>{lbl_c10}</div>
                    <div style='font-family:Share Tech Mono,monospace;
                                font-size:1.1rem;color:{clr_c10};'>{cons_c10:,.0f}</div>
                    <div style='font-size:0.7rem;color:#2E7D32;'>Wh/día</div>
                    <div style='font-size:0.78rem;color:#0B2545;margin-top:0.3rem;'>
                ...
                <div style='background:#F8F9FA;border:1px dashed #0B2545;
                            border-radius:8px;padding:0.8rem;text-align:center;
                            color:#0B2545;font-size:0.8rem;'>{lbl_c10}<br>Sin datos</div>""",
                    unsafe_allow_html=True)
    ...
    for mr in range(mp_rows):
        for mc in range(mp_cols):
            ...
            mini_panels += box(mpx,mpy,mp_w,mp_h,"#0B2545","#0B2545",3)
            # cells 2×3
            cw=(mp_w-8)/2; ch=(mp_h-8)/3
            for cr in range(3):
                for cc in range(2):
                    mini_panels += box(mpx+4+cc*(cw+1.5),mpy+4+cr*(ch+1.5),cw-1,ch-1,"#0B2545","none",1)
    if par10 > 4:
        mini_panels += txt(ARR_X+ARR_W/2, ARR_Y+mp_rows*(mp_h+mp_sep)+34, f"+{par10-4} strings más",7,C_DIM10)

    arr_block = f'''
    <g id="array">
      {box(ARR_X,ARR_Y,ARR_W,ARR_H,"#FFFFFF","#0B2545",8)}
      {box(ARR_X,ARR_Y,ARR_W,22,"#0B2545","#0B2545",8,1,0)}
      ...
      {txt(ARR_X+ARR_W/2,ARR_Y+ARR_H-28,f"Voc={v_array10}V  Isc={i_array10}A",7.5,"#0B2545","middle","normal","Share Tech Mono,monospace")}
    ...
    for bri in range(bat_rows_d):
        for bci in range(min(bat_cols_d,n_bat10-bri*bat_cols_d)):
            ...
            bat_icons += box(bx,by,bw_d,bh_d,"#F8F9FA","#0B2545",3)
            bat_icons += box(bx+bw_d*0.3,by-4,bw_d*0.4,5,"#0B2545","#0B2545",1)  # terminal
    ...
    <g id="protecciones">
      ...
      {box(PROT_X+10,PROT_Y+32,PROT_W-20,28,"#F8F9FA","#FF9F1C",4)}
      ...
      {box(PROT_X+10,PROT_Y+72,PROT_W-20,28,"#F8F9FA","#0B2545",4)}
      ...
      {box(PROT_X+10,PROT_Y+152,PROT_W-20,28,"#F8F9FA","#0B2545",4)}
      {txt(PROT_X+PROT_W/2,PROT_Y+164,"Descargador SPD",7.5,"#0B2545")}
    ...
    title10 = f'''
    <rect x="0" y="{tb_y10}" width="{W10}" height="72" fill="#FFFFFF" stroke="#0B2545" stroke-width="0.8"/>
    ...
    <text x="12" y="{tb_y10+61}" font-family="Share Tech Mono,monospace" font-size="7.5" fill="#0B2545">
        Consumo: {consumo10_fs:,.0f}Wh/día (+25%FS)  |  EcoVolt Pro  |  {datetime.now().strftime("%d/%m/%Y")}  |  Diagrama Unifilar — Plano N°02</text>
    ...
    legend10 = f'''
    <g>
      {box(leg10_x,leg10_y,160,110,"#FFFFFF","#0B2545",6)}
    ...
    with col10a:
        st.markdown(f"""
        <div class='sol-card'>
            <div style='font-family:Rajdhani,sans-serif; color:#FF9F1C; font-weight:600; margin-bottom:0.6rem;'>COMPONENTES DEL SISTEMA</div>
            <div style='font-size:0.82rem; line-height:1.9;'>
                🔆 Array FV: <b style='color:#0B2545;'>{n_pan10} × {pot_panel10}Wp</b><br>
                🎛 MPPT: <b style='color:#0B2545;'>{mppt_label10}</b><br>
                🔋 Baterías: <b style='color:#0B2545;'>{n_bat10} × {bat_cap10}Ah @ {vdc10}V</b><br>
                ⚡ Inversor: <b style='color:#0B2545;'>{inv_kva} kVA DC/AC</b><br>
                🛡 Protecciones: <b style='color:#0B2545;'>Fusibles + SPD + Tierra</b>
            </div>
        </div>""", unsafe_allow_html=True)
    with col10b:
        st.markdown(f"""
        <div class='sol-card'>
            <div style='font-family:Rajdhani,sans-serif; color:#FF9F1C; font-weight:600; margin-bottom:0.6rem;'>PARÁMETROS ELÉCTRICOS</div>
            <div style='font-size:0.82rem; line-height:1.9; font-family:Share Tech Mono,monospace;'>
                Vtensión DC sistema: <b style='color:#0B2545;'>{vdc10} V</b><br>
                Vtensión array: <b style='color:#0B2545;'>{v_array10} V</b><br>
                Corriente array: <b style='color:#0B2545;'>{i_array10} A</b><br>
                Corriente MPPT: <b style='color:#0B2545;'>{corr_mppt10:.0f} A</b><br>
                Energía banco: <b style='color:#2E7D32;'>{ah_banco10*vdc10/1000:.1f} kWh</b>
            </div>
        </div>""", unsafe_allow_html=True)
    with col10c:
        st.markdown(f"""
        <div class='sol-card'>
            <div style='font-family:Rajdhani,sans-serif; color:#FF9F1C; font-weight:600; margin-bottom:0.6rem;'>ENERGÉTICO</div>
            <div style='font-size:0.82rem; line-height:1.9; font-family:Share Tech Mono,monospace;'>
                Consumo base: <b style='color:#0B2545;'>{consumo_base10:,.0f} Wh/día</b><br>
                Consumo + 25%FS: <b style='color:#0B2545;'>{consumo10_fs:,.0f} Wh/día</b><br>
                HSP: <b style='color:#0B2545;'>{hsp10} h/día</b><br>
                Potencia instalada: <b style='color:#0B2545;'>{pot_inst10:,.0f} Wp</b><br>
                Municipio: <b style='color:#2E7D32;'>{p10[2] if p10 and p10[2] else "—"}</b>
            </div>
        </div>""", unsafe_allow_html=True)
    ...
    if consumo_base_eco == 0:
        ...
        with col_eco2:
            ...
            <div class='result-highlight' style='border-color:rgba(0,230,118,0.5);
                ...
                <div class='val' style='color:#2E7D32;'>${ahorro_mes_eco:,.0f} / mes</div>
            </div>
            <div class='metric-grid' style='margin-top:0.8rem;'>
                ...
                <div class='metric-box' style='border-color:rgba(0,230,118,0.5);'>
                    <div class='metric-val' style='color:#2E7D32;'>${ahorro_anio_eco:,.0f}</div>
                ...
                <div class='metric-box' style='border-color:rgba(0,188,212,0.5);'>
                    <div class='metric-val' style='color:#0B2545;'>{payback_eco:.1f}</div>
                    <div class='metric-unit'>años</div>
                    <div class='metric-label'>PAYBACK</div>
                </div>
                <div class='metric-box' style='border-color:rgba(0,188,212,0.5);'>
                    <div class='metric-val' style='color:#0B2545;'>{tir_eco:.1f}%</div>
                    <div class='metric-unit'>/ año</div>
            ...
            <div class='sol-card' style='margin-top:0.8rem;'>
                ...
                <table style='width:100%;font-size:0.82rem;border-collapse:collapse;'>
                    <tr style='border-bottom:1px solid #0B2545;'>
                        <td style='color:#2E7D32;padding:0.35rem 0;'>Paneles ({n_pan_eco} × ${ppanel_eco:,.0f})</td>
                        <td style='font-family:Share Tech Mono;color:#0B2545;text-align:right;'>${inv_pan_eco:,.0f}</td>
                    </tr>
                    <tr style='border-bottom:1px solid #0B2545;'>
                        <td style='color:#2E7D32;padding:0.35rem 0;'>Baterías ({n_bat_eco} × ${pbat_eco:,.0f})</td>
                        <td style='font-family:Share Tech Mono;color:#0B2545;text-align:right;'>${inv_bat_eco:,.0f}</td>
                    </tr>
                    <tr style='border-bottom:1px solid #0B2545;'>
                        <td style='color:#2E7D32;padding:0.35rem 0;'>Controlador MPPT</td>
                        <td style='font-family:Share Tech Mono;color:#0B2545;text-align:right;'>${pcontrol_eco:,.0f}</td>
                    </tr>
                    <tr style='border-bottom:1px solid #0B2545;'>
                        <td style='color:#2E7D32;padding:0.35rem 0;'>Inversor</td>
                        <td style='font-family:Share Tech Mono;color:#0B2545;text-align:right;'>${pinv_eco:,.0f}</td>
                    </tr>
                    <tr style='border-bottom:1px solid #0B2545;'>
                        <td style='color:#2E7D32;padding:0.35rem 0;'>Otros (estructura + cable + MO)</td>
                        <td style='font-family:Share Tech Mono;color:#0B2545;text-align:right;'>${potros_eco:,.0f}</td>
                    </tr>
                    <tr style='background:#FFFFFF;border-bottom:1px solid #0B2545;'>
                        <td style='color:#FF9F1C;padding:0.4rem 0;font-weight:700;'>INVERSIÓN TOTAL</td>
                        <td style='font-family:Share Tech Mono;color:#FF9F1C;text-align:right;
                                   font-weight:700;font-size:0.95rem;'>${inv_total_eco:,.0f}</td>
                    </tr>
                    <tr style='border-bottom:1px solid #0B2545;'>
                        <td style='color:#2E7D32;padding:0.35rem 0;'>Ahorro mensual</td>
                        <td style='font-family:Share Tech Mono;color:#2E7D32;text-align:right;'>${ahorro_mes_eco:,.0f}</td>
                    </tr>
                    <tr style='background:#FFFFFF;'>
                        <td style='color:#2E7D32;padding:0.4rem 0;font-weight:700;'>AHORRO ANUAL</td>
                        <td style='font-family:Share Tech Mono;color:#2E7D32;text-align:right;
        ...
        for c_amb, icon_a, lbl_a, val_a, unit_a, col_a in [
            (col_amb1, "🌿", "CO₂ evitado/año",   f"{co2_eco:,.0f}",   "kg CO₂",    "#0B2545"),
            (col_amb2, "🌳", "Árboles equiv./año", f"{arboles_eco:.0f}", "árboles",   "#2E7D32"),
            (col_amb3, "☀", "Generación anual",   f"{gen_anio_eco:,.0f}","kWh/año",  "#FF9F1C"),
            (col_amb4, "📅", "Vida útil sistema",  "20–25",              "años",      "#2E7D32"),
        ]:
            with c_amb:
                st.markdown(f"""
        ...
        with col_sum1:
            ...
            <div class='sol-card'>
                ...
                <div style='font-size:0.82rem;line-height:2;font-family:Share Tech Mono,monospace;'>
                    Paneles: <b style='color:#0B2545;'>{n_pan_eco} × {pot_panel_eco} Wp</b><br>
                    Pot. inst.: <b style='color:#0B2545;'>{n_pan_eco*pot_panel_eco/1000:.2f} kWp</b><br>
                    Gen. día: <b style='color:#2E7D32;'>{gen_dia_eco:.2f} kWh/día</b><br>
                    HSP bruta: <b style='color:#0B2545;'>{hsp_eco} h/día</b><br>
                    PR aplicado: <b style='color:#FF9F1C;'>{int(pr_eco*100)}%</b><br>
                    HSP efectiva: <b style='color:#FF9F1C;'>{hsp_ef_eco:.2f} h/día</b>
                </div>
            </div>""", unsafe_allow_html=True)
        with col_sum2:
            st.markdown(f"""
            <div class='sol-card'>
                ...
                <div style='font-size:0.82rem;line-height:2;font-family:Share Tech Mono,monospace;'>
                    N° baterías: <b style='color:#0B2545;'>{n_bat_eco} unidades</b><br>
                    Cap. banco: <b style='color:#0B2545;'>{ah_eco} Ah @ {vdc_eco}V</b><br>
                    Energía: <b style='color:#2E7D32;'>{ah_eco*vdc_eco/1000:.2f} kWh</b><br>
                    Tensión DC: <b style='color:#0B2545;'>{vdc_eco} V</b>
                </div>
            </div>""", unsafe_allow_html=True)
        with col_sum3:
            st.markdown(f"""
            <div class='sol-card'>
                ...
                <div style='font-size:0.82rem;line-height:2;font-family:Share Tech Mono,monospace;'>
                    Base: <b style='color:#0B2545;'>{consumo_base_eco:,.0f} Wh/día</b><br>
                    Con 25% FS: <b style='color:#0B2545;'>{consumo_fs_eco:,.0f} Wh/día</b><br>
                    Mensual: <b style='color:#2E7D32;'>{consumo_base_eco*30/1000:.1f} kWh/mes</b><br>
                    Anual: <b style='color:#0B2545;'>{consumo_base_eco*365/1000:.0f} kWh/año</b>
                </div>
            </div>""", unsafe_allow_html=True)
...
# ─── FOOTER ─────────────────────────────────────────────────────────────────
st.markdown("""
<div style='text-align:center; padding:2rem 0 1rem; color:#0B2545; font-size:0.75rem; letter-spacing:2px;'>
    ECOVOLT PRO · DIMENSIONAMIENTO FOTOVOLTAICO OFF-GRID · SQLITE3 + STREAMLIT
</div>
""", unsafe_allow_html=True)
