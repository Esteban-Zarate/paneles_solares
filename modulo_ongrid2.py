...
def mostrar_ongrid(proyecto_id: int, session_state: dict) -> None:
    ...
    with tab_og1:
        ...
        for c, val, unit, lbl, col in [
            ...
            (col4, consumo_fs_og, "Wh/día", "Con 10% FS sistema", "#FF9F1C"),
        ]:
            with c:
                st.markdown(f"""
    ...
    with tab_og2:
        ...
        with col_hsp1:
            ...
            <div class='sol-card'>
                ...
                <div style='font-size:0.85rem;color:#2E7D32;line-height:1.9;'>
                    <b style='color:#0B2545;'>PVGIS (Europa JRC)</b><br>
        ...
        with col_hsp2:
            ...
            <div class='result-highlight'>
                ...
                <div style='color:#0B2545;font-size:0.85rem;margin-top:0.3rem;'>
    ...
    with tab_og4:
        ...
        with col_d2:
            ...
            <div class='result-highlight' style='border-color:rgba(255,107,53,0.5);
                ...
                <div class='val' style='color:#FF9F1C;'>{pot_array_wp/1000:.2f} kWp</div>
            </div>
    ...
    with tab_og5:
        ...
        with col_e2:
            if pot_inst_og2 == 0 or consumo_og2 == 0:
                ...
                <div class='metric-grid'>
                    <div class='metric-box' style='border-color:rgba(0,230,118,0.5);'>
                        <div class='metric-val' style='color:#2E7D32;'>{gen_dia:.2f}</div>
                    ...
                    <div class='metric-box' style='border-color:rgba(255,107,53,0.5);'>
                        <div class='metric-val' style='color:#FF9F1C;'>{autoconsumo_pct:.0f}%</div>
                    ...
                    <div class='metric-box' style='border-color:rgba(0,230,118,0.5);'>
                        <div class='metric-val' style='color:#2E7D32;'>{payback:.1f}</div>
                ...
                <div class='sol-card' style='margin-top:0.8rem;'>
                    ...
                    <table style='width:100%;font-size:0.83rem;border-collapse:collapse;'>
                        <tr style='border-bottom:1px solid #0B2545;'>
                            <td style='color:#2E7D32;padding:0.4rem 0;'>Inversión paneles</td>
                            <td style='font-family:Share Tech Mono;color:#0B2545;text-align:right;'>${inv_paneles:,.0f}</td>
                        </tr>
                        <tr style='border-bottom:1px solid #0B2545;'>
                            <td style='color:#2E7D32;padding:0.4rem 0;'>Inversión inversor</td>
                            <td style='font-family:Share Tech Mono;color:#0B2545;text-align:right;'>${inv_inv:,.0f}</td>
                        </tr>
                        <tr style='border-bottom:1px solid #0B2545;'>
                            <td style='color:#2E7D32;padding:0.4rem 0;'>Otros (estructura+cableado)</td>
                            <td style='font-family:Share Tech Mono;color:#0B2545;text-align:right;'>${otros_costos:,.0f}</td>
                        </tr>
                        <tr style='border-bottom:1px solid #0B2545;background:#FFFFFF;'>
                            <td style='color:#FF9F1C;padding:0.4rem 0;font-weight:600;'>Inversión total</td>
                            <td style='font-family:Share Tech Mono;color:#FF9F1C;text-align:right;font-weight:700;'>${inv_total:,.0f}</td>
                        </tr>
                        <tr style='border-bottom:1px solid #0B2545;'>
                            <td style='color:#2E7D32;padding:0.4rem 0;'>Ahorro mensual (autoconsumo)</td>
                            <td style='font-family:Share Tech Mono;color:#2E7D32;text-align:right;'>${ahorro_mes:,.0f}</td>
                        </tr>
                        <tr style='border-bottom:1px solid #0B2545;'>
                            <td style='color:#2E7D32;padding:0.4rem 0;'>Ingreso inyección red</td>
                            <td style='font-family:Share Tech Mono;color:#FF9F1C;text-align:right;'>${ing_iny_mes:,.0f}</td>
                        </tr>
                        <tr style='border-bottom:1px solid #0B2545;background:#FFFFFF;'>
                            <td style='color:#2E7D32;padding:0.4rem 0;font-weight:600;'>Beneficio mensual total</td>
                            <td style='font-family:Share Tech Mono;color:#2E7D32;text-align:right;font-weight:700;'>${beneficio_mes:,.0f}</td>
                        </tr>
                        <tr style='border-bottom:1px solid #0B2545;'>
                            <td style='color:#2E7D32;padding:0.4rem 0;'>CO₂ evitado / año</td>
                            <td style='font-family:Share Tech Mono;color:#0B2545;text-align:right;'>{co2_anio:.0f} kg</td>
                        </tr>
                        <tr>
                            <td style='color:#2E7D32;padding:0.4rem 0;'>TIR simplificada</td>
                            <td style='font-family:Share Tech Mono;color:#0B2545;text-align:right;'>{tir_aprox:.1f}% / año</td>
                        </tr>
                    </table>
                </div>""", unsafe_allow_html=True)
